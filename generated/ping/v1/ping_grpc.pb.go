...
type PingServiceClient interface {
	Ping(ctx context.Context, in *LastUserPingRequest, opts ...grpc.CallOption) (*PingResponse, error)
}
...
func (c *pingServiceClient) Ping(ctx context.Context, in *LastUserPingRequest, opts ...grpc.CallOption) (*PingResponse, error) {
...
type PingServiceServer interface {
	Ping(context.Context, *LastUserPingRequest) (*PingResponse, error)
...
func (UnimplementedPingServiceServer) Ping(context.Context, *LastUserPingRequest) (*PingResponse, error) {
...
func _PingService_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PingServiceServer).Ping(ctx, req.(*LastUserPingRequest))
	}
